...
let handler = async (m, { conn, command, args }) => {
    ...
    users[userId].emerald += jum; // Tambahkan uang ke pengguna
    conn.reply(m.chat, `Sukses menambah emerald sebanyak ${jum}.`, m);
...
handler.help = ['addemerald'];
handler.tags = ['premium'];
handler.command = /^addemerald$/i;
