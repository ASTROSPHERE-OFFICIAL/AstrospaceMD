...
export async function deleteUpdate(message) {
	try {
		...
		// Tidak melakukan tindakan apa pun saat pesan dihapus
	} catch (e) {
		console.error(e)
	}
}
...
global.dfail = (type, m, conn) => {
	let msg = {
		rowner: 'Perintah ini untuk *R-OWNER*',
		owner: 'Perintah ini untuk *OWNER* ',
		mods: 'Perintah ini untuk *MODS* ',
		premium: 'Perintah ini untuk *PREMIUM* \n\n> Please send *.order* to purchase the *Premium* plan',
		group: 'Perintah ini untuk *GROUP* ',
		private: 'Perintah ini untuk *PRIVATE* ',
		admin: 'Perintah ini untuk *ADMINS* ',
		botAdmin: 'Perintah ini untuk *BOT-ADMINS* ',
		prem: 'Perintah ini untuk *PREMIUM* ',
		nsfw: 'Perintah ini belum diaktifkan di grup ini.\n\n> Aktifkan Fitur Ini Dengan Mengetik *.enable nsfw*',
		rpg: 'Perintah ini belum diaktifkan di grup ini.\n\n> Aktifkan Fitur Ini Dengan Mengetik *.enable rpg*',
		game: 'Perintah ini belum diaktifkan di grup ini.\n\n> Aktifkan Fitur Ini Dengan Mengetik *.enable game*',
		xmaze: 'Grup ini tidak mengizinkan penggunaan fitur ini. Silakan bergabung dengan grup ini:\nhttps://chat.whatsapp.com\n\n disable this feature by writing .enable allfitur',
		restrict: '*FEATURES TURNED OFF BY OWNERS*',
		unreg: '*DAFTAR DULU*\n*Baca Cara Daftar Di bawah:\n\n*.daftar namalu.umurlu\nIni Contoh!!!: *.daftar Astrospace.19*\n\nPerhatikan Tanda Titik !'
	} [type]
